...
template <class _ST>
vec3<_ST> vec3<_ST>::x_axis(_ST(1), _ST(0), _ST(0));
template <class _ST>
vec3<_ST> vec3<_ST>::y_axis(_ST(0), _ST(1), _ST(0));
template <class _ST>
vec3<_ST> vec3<_ST>::z_axis(_ST(0), _ST(0), _ST(1));
template <class _ST>
vec3<_ST> vec3<_ST>::null(_ST(0), _ST(0), _ST(0));
