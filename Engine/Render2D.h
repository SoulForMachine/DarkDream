...
#include "Engine/Renderer/GPUProgram.h"
...
#pragma pack(pop)
		...
		const ShaderRes* _vsText;
		const ShaderRes* _fsText;
		GPUProgram _progText;
		...
		const ShaderRes* _vsRect2D;
		const ShaderRes* _fsRect2D;
		GPUProgram _progRect2D;
